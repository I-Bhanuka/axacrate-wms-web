                        ...
                        <div key={zoneType} className="flex items-center flex-1 min-w-0">
                                    ...
                                    <div>
                                        ...
                                        {zone.hasHardware && (
                                            <div className="mt-2 flex items-center gap-1">
                                                ...
                                                <span
                                                    className={`text-[10px] truncate ${isOffline ? "text-red-400" : "text-white/30"
                                                        }`}
                                                >
                            ...
                            {idx < ZONE_ORDER.length - 1 && (
                                <div className="flex flex-col items-center px-1.5 flex-shrink-0 gap-0.5">
                                    <ArrowRight
                                        className={`h-3.5 w-3.5 ${hasArrow ? "text-emerald-500" : "text-white/10"
                                            }`}
                                    />
                                </div>
                            )}
...
function ViolationLog({
    ...
    const tabBtn = (t: ViolationTab, label: string, count: number) => (
        <button
            key={t}
            onClick={() => setTab(t)}
            className={`text-[11px] font-semibold uppercase tracking-wider px-3 py-1.5 rounded-md transition-colors cursor-pointer flex items-center gap-1.5 ${tab === t
        ...
        >
            ...
            {count > 0 && (
                <span
                    className={`inline-flex items-center justify-center h-4 min-w-4 px-1 rounded-full text-[10px] font-bold ${t === "pending"
                                ...
                                >
                                    ...
                                    <TableCell className="text-[11px] text-white/35 whitespace-nowrap py-3">
                                        <div className="flex items-center gap-1.5">
                                            <div
                                                className={`h-1.5 w-1.5 rounded-full flex-shrink-0 ${SEVERITY_DOT[alert.severity] ?? "bg-white/20"
                                                    }`}
                                            />
                                    ...
                                    <TableCell className="py-3">
                                        <span
                                            className={`inline-flex items-center text-[10px] font-semibold px-2 py-0.5 rounded-full border whitespace-nowrap ${SEVERITY_BADGE[alert.severity] ??
                                    ...
                                    <TableCell className="py-3">
                                        <span
                                            className={`inline-flex items-center text-[10px] font-semibold px-2 py-0.5 rounded-full border whitespace-nowrap ${STATUS_BADGE[alert.alertStatus] ??
                                                "bg-white/10 text-white/50 border-white/10"
                                                }`}
                                        >
                                            {alert.alertStatus}
